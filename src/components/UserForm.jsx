  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-3xl mx-auto p-4 bg-white rounded shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <input name="cpf" value={formData.cpf} onChange={handleChange} placeholder="CPF" className="p-2 border rounded" required />
        ...
        <input name="telefone" value={formData.telefone} onChange={handleChange} placeholder="Telefone" className="p-2 border rounded" required />
        ...
        <input name="cep" value={formData.cep} onChange={handleChange} placeholder="CEP" className="p-2 border rounded" />
        ...
        {tipoPessoa === 'juridica' && (
          <>
            ...
            <input name="cnpj" value={formData.cnpj} onChange={handleChange} placeholder="CNPJ" className="p-2 border rounded" required />
          </>
        )}
      </div>
      ...
      {formData.outroTitular && (
        <div className="border p-4 rounded bg-gray-50 mb-6">
          ...
          <input name="cpfTitular" value={formData.cpfTitular} onChange={handleChange} placeholder="CPF do titular" className="p-2 border rounded w-full mb-2" />
